...
import { Briefcase, Check, Crown, Gift, Rocket, Sparkles, X } from "lucide-react";
  ...
  return (
    <section id="offres" className={cn("w-full bg-muted/40 px-4 py-24 text-foreground md:px-8", className)}>
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:items-stretch">
          {plans.map((plan, i) => {
                ...
                >
                  ...
                  <CardContent className="flex flex-1 flex-col text-center">
                    ...
                    <Button
                      ...
                      className={cn(
                        "mb-6 h-11 w-full rounded-xl text-sm font-semibold",
